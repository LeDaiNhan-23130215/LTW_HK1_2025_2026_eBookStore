...
public class PooledConnection implements Connection{
    ...
    private boolean isClose = false; //Biến tránh close 2 lần

    public PooledConnection(Connection realConnection, ConnectionPool connectionPool) {
    ...
    public CallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        return realConnection.prepareCall(sql, resultSetType, resultSetConcurrency, resultSetConcurrency);
    }
