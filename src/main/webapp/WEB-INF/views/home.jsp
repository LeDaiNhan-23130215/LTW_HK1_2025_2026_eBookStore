  ...
  <div class="headerContainer">
    <div class="topBar">
      ...
      <div class="rightContainer">
        <a href="WEB-INF/views/login.jsp">Đăng nhập</a>
        <a href="WEB-INF/views/sign-up.jsp">Đăng ký</a>
        <p>
          Hotline:
    ...
    <div class="headerMenu">
      ...
      <div class="categorymenu">
        <a href="WEB-INF/views/category.jsp"
...
<footer id="siteFooter">
  ...
  <div class="footer-container">
    <div class="left">
      ...
      <a href="WEB-INF/views/address.jsp" class="address">
    ...
    <div class="cs-hd-dm">
      ...
      <div class="option">
        <h3>DANH MỤC</h3>
        <ul>
          <li><a href="home-Login.jsp">Trang chủ</a></li>
          <li><a href="WEB-INF/views/about.jsp">Giới Thiệu</a></li>
          <li><a href="WEB-INF/views/news.jsp">Tin tức</a></li>
          <li><a href="WEB-INF/views/contact.jsp">Liên hệ</a></li>
          <li><a href="WEB-INF/views/faq.jsp">FAQ</a></li>
        </ul>
      </div>
      ...
      <div class="kn-tt">
        ...
        <div class="footer-feedback">
          ...
          <a href="WEB-INF/views/feedback.jsp" class="feedback-button">
            Feedback</a
          >
        </div>
